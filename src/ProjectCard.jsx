...
const ProjectCard = ({ project }) => {
    ...
    return (
        <div className="items-center border-blue-600  border-2  p-2 rounded relative">
            <Carousel autoPlay={true} axis={"horizontal"} dynamicHeight={400} showThumbs={false} infiniteLoop={true} interval={3000} className="w-full mx-auto rounded-lg md:rounded-none hover:border-red-800">
                <div>
                    <img src={image1} className="w-full lg:h-[350px] md:h-[320px] h-[250px] rounded" />
                </div>
                <div>
                    <img src={image2} className="w-full lg:h-[350px] md:h-[320px] h-[250px] rounded" />
                </div>
                <div>
                    <img src={image3} className="w-full lg:h-[350px] md:h-[320px] h-[250px] rounded" />
                </div>
                <div>
                    <img src={image4} className="w-full lg:h-[350px] md:h-[320px] h-[250px] rounded" />
                </div>
                <div>
                    <img src={image5} className="w-full lg:h-[350px] md:h-[320px] h-[250px] rounded" />
                </div>
                <div>
                    <img src={image6} className="w-full lg:h-[350px] md:h-[320px] h-[250px] rounded" />
                </div>
                <div>
                    <img src={image7} className="w-full lg:h-[350px] md:h-[320px] h-[250px] rounded" />
                </div>
            ...
            <div className="flex justify-center gap-6 absolute bottom-2 left-0 right-0">
